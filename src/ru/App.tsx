...
function Solution() {
  const solutions = [
    ...
    },
    {
      ...
      description:
        'Регистрация и вход через Google/Facebook или Magic Link. Конверсия мгновенно растёт с 4% до 9%. Вы перестаёте терять пользователей. Пользователи больше не испытывают раздражения и мгновенно попадают на ваш сайт без усилий. Максимальная безопасность аутентификации.',
      image: 'right',
    },
    {
      icon: BarChart3,
