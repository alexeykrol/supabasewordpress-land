...
- **Tailwind CSS 3.4.1** + **Framer Motion 12** (animations)
- **Lucide React** (icons) + **@fontsource/inter** (self-hosted fonts)
- **Security:** CSP headers, A+ rating, GDPR compliant

---

## 📊 Current State

**Architecture:** Bilingual routing (src/ru/App.tsx + src/en/App.tsx)
**Components:** 9 major sections (Navigation, Hero, Problem, Solution, SocialProof, Statistics, Manifesto, DualCTA, Footer)
**Performance:** <1.0s FCP, ~90KB gzipped bundle
